                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="#" onclick="document.getElementById('id01').style.display='block'"><i class="fa fa-user fa-fw"></i>Registrarse</a>
                            </li>
                            <li class="divider"></li>
   ...
   $verificacion=consulta($miconexion,"SELECT  EXISTS(select * from administrador where trim(correo_adm) like '{$correo_usuario}'  ) ");
    ...
    {      
         ...
         $resultado=consulta($miconexion,"insert into administrador (tipo_doc_adm,num_id_adm,nombre_adm,apellido_adm,telefono_adm,direccion_adm,correo_adm,fecha_nacimiento_adm,nacionalidad_adm,codigo_empleado_adm,contraseña_adm)
          ...
          /* 
          $resultado=consulta($miconexion,"update
          administrador set tipo_id_adm='{$tipod_usuario}',num_id_adm='{$numero_usuario}', nombre_adm='{$nombre_usuario}', apellido_adm='{$apellido_usuario}',telefono_adm='{$tel_usuario}'
          where codigo_empleado_adm='{$codigo_em}'");
