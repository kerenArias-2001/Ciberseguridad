                            ...
                            <table>
                                ...
                                <td colspan="3">  Código del incidente:
                                    <?php
                                        ...
                                        $valor=$fila->id_in; */
                                    ?>                                      
                                    <label id="version_i" name="cod_in" type="text" class="form-control3" placeholder='' value="<?php echo"".$codigo_in;?>" ></label>
                                    Fecha:
                                    <?php
                                    // Obteniendo la fecha actual con hora, minutos y segundos en PHP
                                    $fechaActual = date('d-m-Y H:i:s');
                                    ?>
                                    <label id="fecha_r" name="fecha_r" type="datetime-local" class="form-control3" >
                                    Responsable:<!--  <label type="text" class="texc1r" id="inc_3" readonly="readonly"></input> -->
                                    <label id="resp_i" name="responsable_in" type="text" class="form-control3" >
                                </td>
                                </tr>
                                <tr class="fondo_sub">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <label id="fecha_hora" name="fecha_hora_reporte" type="datetime-local" class="form-control3">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <label id="rep_i" name="nombre_quien_reporta" type="text" class="form-control3" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>Cargo:</td>
                                    ...
                                    <td>
                                        <label id="dep_i" name="codigo_emp" type="text" class="form-control3" >                                              
                                    </td>
                                </tr>
                                <tr>
                                        <td>Sede:</td>
                                        <td> <!-- <label type="text" class="texc1" id="inc_8" readonly="readonly"></input> -->
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <label id="fech_hora" name="fech_hora_in" type="datetime-local" class="form-control3" >
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <label id="lugar_i" name="lugar_in" type="text" class="form-control3"  minlength="10" maxlength="80"  placeholder="Máximo 80 caracteres" >
                                    </td>
                                </tr>
                                <tr class="fondo_sub">
                                ...
                                <tr>
                                    ...
                                    <td colspan="1">
                                     <label id="lugar_i" name="SN_in" type="text" class="form-control3"  minlength="10" maxlength="80"  placeholder="Máximo 80 caracteres" >
                                    </td>
                                    <td colspan="1">Marca
                                    </td> 
                                    <td colspan="1">
                                     <label id="lugar_i" name="marca_in" type="text" class="form-control3"  minlength="10" maxlength="80"  placeholder="Máximo 80 caracteres" >
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">modelo </td> 
                                    <td colspan="2">
                                        <label id="lugar_i" name="modelo_in" type="text" class="form-control3"  minlength="10" maxlength="80"  placeholder="Máximo 80 caracteres" >
                                    </td>
                                </tr>
                                </tr>
                            </table>
