...
<head>
    ...
    <title>Consultar Activo | Ciberseguridad</title>
        ...
        <section id="acuerdo" style="background-color: aqua; height: 562px;">
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="page-header">Consultar Activo</h2>
                        </div>
                    </div>
                    <div class="cont-b">
                        <center> 
                                ...
                                <div class="text_acta">
                                    ...
                                    <table>
                                        <tr class="fondo_sub2">
                                            ...
                                            <label id="version_i" name="identificador" type="text" class="form-control3"> <?php echo"".$identificador;?>  </label>
                                            ...
                                            ?>
                                            <label id="fecha_r" name="fecha" type="text" class="form-control3" ><?php echo "".$fecha ;?> </label>
                                            Responsable:<label id="responsable" name="responsable" type="text" class="form-control3"> <?php echo"".$responsable;?> </label>
                                            </td>
                                        </tr>
                                        <tr class="fondo_sub">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                            <label id="nomb_act" class="form-control3" name="nombre_act"><?php echo"".$nombre_act;?></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="1"><label for="desc_act">Descripción / Observaciones:</label></td> 
                                            <td colspan="3">
                                                <label class="form-control3" id="inc_13" name="observaciones"><?php echo"".$observaciones;?></label>

                                            </td>
                                            <td colspan="1"><label for="tipo_act">Tipo</label></td> 
                                            <td colspan="2">
                                            <label id="tipo_act" class="form-control3" name="tipo_activo"><?php echo"".$tipo_activo;?></label>
                                            </td>
                                        </tr>                                           
                                        <tr>
                                            ...
                                            <td colspan="4"> 
                                            <label id="conf_a" class="form-control3" name="confidencialidad"><?php echo"".$confidencialidad ;?></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td colspan="4"> 
                                            <label id="integ_a" class="form-control3" name="integridad"><?php echo"".$integridad ;?></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td colspan="4">
                                            <label id="disp_a" class="form-control3" name="disponibilidad"><?php echo"".$disponibilidad ;?></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="1"><label for="ubi_ac">UBICACIÓN</label></td> 
                                            <td colspan="2">
                                            <label id="ubi_ac" class="form-control3" name="ubicacion_act"><?php echo"".$ubicacion_act ;?></label>
                                            ...
                                            <td colspan="2">
                                            <label id="niv_act" class="form-control3" name="criticidad_act"><?php echo"".$criticidad_act ;?></label>
                                            </td>
                                        </tr>                     
                                        <tr>
                                            <td colspan="1"><label for="just_act">Justificación:</label></td> 
                                            <td colspan="5">
                                            <label id="just_act" name="justificacion_act" type="text"class="form-control3"> <?php echo "".$justificacion_act;?> </label>               
                                            </td>
                                        </tr>
                                        <tr class="fondo_sub">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <label id="prop_act" name="propietario_act"  class="form-control3">   <?php echo "".$propietario_act;?> </label>                             
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="1"><label for="cust_act">Custodio:</label></td> 
                                            <td colspan="5">
                                                <label id="cust_act" name="custodio_act" type="text" class="form-control3" ><?php echo "".$custodio_act;?> </label>                               
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="1"><label for="fecha_act">Fecha ingreso del Activo:</label></td> 
                                            <td colspan="3">
                                            <label id="fecha_r" name="fecha_ingr_act"   class="form-control3"><?php echo "".$fecha_ingr_act ;?> </label>

                                            </td>
                                            <td colspan="1"><label for="fecha1_act">Fecha salida del Activo:</label></td> 
                                            <td colspan="2">
                                            <label id="fecha_r" name="fecha_sali_act"  class="form-control3"><?php echo "".$fecha_sali_act ;?> </label>
                     ...
                     /* -----------------Alerta  ------------------------*/
                        ...
                        echo "<script>
                            Swal.fire({type: 'error',
                                ...
                                window.location = '../pages/activo_consultar.php';
                            });
                            </script>" ;
                    }          
